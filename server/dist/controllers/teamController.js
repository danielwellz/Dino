...
const addTeamMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const assignedRole = (role && Object.values(client_1.TeamMemberRole).includes(role))
            ? role
            : client_1.TeamMemberRole.MEMBER;
...
const removeTeamMember = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (adminCount === 1 && (memberToRemove === null || memberToRemove === void 0 ? void 0 : memberToRemove.role) === client_1.TeamMemberRole.OWNER) {
...
const updateTeamMemberRole = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!newRole || !Object.values(client_1.TeamMemberRole).includes(newRole)) {
        ...
        // Prevent removing the last admin
        if (memberToUpdate.role === client_1.TeamMemberRole.OWNER && newRole !== client_1.TeamMemberRole.OWNER) {
            const adminCount = yield prisma.teamMember.count({
                where: {
                    teamId: teamIdNumber,
                    role: client_1.TeamMemberRole.OWNER
